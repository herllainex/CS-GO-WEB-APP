...
LinkedQueue.prototype.initHeadNode = function() {
	...
	// 绘制头结点
	{
		this.cmd("SetState", "Create the head pointer for the linked list. This linked list is a singly linked list with a header, allowing the insertion of elements starting from 1.");
